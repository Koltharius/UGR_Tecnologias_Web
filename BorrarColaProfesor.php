            ...
            <div id="contenedor" class="">
                ...
                <div>
                    <div id="general">
                            ...
                            <div id="enlaces_secciones" class="mod-menu_secciones">
                                <ul>
                                    ...
                                    <ul>
                                        ...
                                        <li class="selected tipo1-selected item-second_level" onclick="cogerDatos('BorrarColaProfesor.php?codigo=', 'enlace_borrar1')">
                        ...
                        <div id="pagina">
                            <h1 id="titulo_pagina"><span class="texto_titulo">Borrar revisión</span></h1>
                            <div style="text-align:center">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        ?>
                                <form id="identif" style="text-align:center" method="post" action="BorrarRegistroCola.php" onsubmit="return borrarColaProfesor()">
                                                                ...
                                                                <tbody>
                                                                    <tr> 
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="text" name="lugarDeRevision" value="<?php echo $row['Lugar'] ?>" readonly="readonly"/><br></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;"> Fecha de revisión: </td>
                                                                            <td><input type="date" name="fechaRevision" value="<?php echo $row['Fecha'] ?>" readonly="readonly"/><br></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;"> Hora de revisión: </td>
                                                                            <td><input type="time" name="horaRevision" value="<?php echo $row['Hora'] ?>" readonly="readonly"/><br></td>
                                                                        </tr>
