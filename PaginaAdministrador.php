                                ...
                                <tr>
                                    <td width="75%" align="left">
                                        ...
                                        <td style="text-align: right;">
                                            <b>Usuario:</b> <?php echo $_SESSION['nombre'] ?>
                                            <br/>
                    ...
                    <div id="general">
                        ...
                        <div id="menus">
                            <div id="enlaces_secciones" class="mod-menu_secciones">
                                <ul>
                                    <li class="selected tipo2-selected item-first_level"><a href="PaginaAdministrador.php">Inicio</a></li>
                        ...
                        <div id="pagina">
                            <h1 id="titulo_pagina"><span class="texto_titulo">Inicio administrador</span></h1>
                            <div style="text-align:center">
                                <br /><br />
                                <img title="Departamento de Ciencias de la Computación e Inteligencia Artificial DECSAI" alt="logo" src="img/WebDECSAI.png"></img>
                                <br /><br />
                            </div>
                        </div>
                    </div>
