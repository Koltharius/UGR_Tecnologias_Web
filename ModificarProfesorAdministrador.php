                ...
                <ul>
                    <li class="tipo2 item-first_level"><a href="PaginaAdministrador.php">Inicio</a></li>  
	                  <li class="selected tipo2-selected item-first_level"><a href="GestionUsuarioAdministrador.php">Gestión de usuarios</a></li>
	                        ...
	                        <li class="selected tipo1-selected item-second_level"><a href="ModificarProfesorAdministrador.php">Modificar datos profesor</a></li>
	                  ...
	                  <li class="tipo2 item-first_level"><a href="index.php">Crear aviso</a></li>
