...
//Compruebo que el usuario esta logueado y que su sesion no ha expirado y que su rol es de profesor
                            ...
                            <div style="text-align:center">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        ?>
                                        <form id="identif" style="text-align:center"   onsubmit="return validateFormColasProfesor()" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
