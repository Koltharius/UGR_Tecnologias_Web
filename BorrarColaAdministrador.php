            ...
            <div id="contenedor" class="">
                ...
                <div>
                    <div id="general">
                        ...
                        <div id="menus">
                            <div id="enlaces_secciones" class="mod-menu_secciones">
                                <ul>
                                    ...
                                    <li class="tipo2 item-first_level"><a href="GestionUsuarioAdministrador.php">Gesti&oacute;n de usuarios</a></li>
                                    ...
                                    <ul>
                                        ...
                                        <li class="selected tipo1-selected item-second_level"><a href="BorrarColaAdministrador.php">Borrar cola</a></li>
                                    </ul>
                        ...
                        <div id="pagina">
                            <h1 id="titulo_pagina"><span class="texto_titulo">Borrar revisi&oacute;n</span></h1>
                            <div style="text-align:center">

                                <!--Se recogen los datos del formulario relativas a  
                                la cola seleccionada para ser borrada.
                                Una vez que se indica que se desea borrar dicha cola
                                se pide confirmación. Una vez confirmado la cola es eliminada de la BD-->
                                <?php
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        ?>
                                        <form id="identif" style="text-align:center" method="post" action="BorrarRegistroCola.php" onsubmit="return borrarCola()">
                                            <table style="width:100%; margin:1px;" align="center" cellpadding="4" cellspacing="4">
                                                <tbody><tr> 
                                                        <td><div style="font-size: 18px; color:  #243349;" align="center"><b>Borrar datos de la revisión</b></div></td>
                                                    </tr>
                                                    <tr align="center"> 
                                                        <td> 
                                                            <table class="formulario-datos"  cellpadding="9" cellspacing="6" align="center" >
                                                                <tbody>
                                                                    ...
                                                                    <tr> <tr>
                                                                            ...
                                                                            <td> 
                                                                                <input type="text" name="codigo" value="<?php echo $row['codigo_revision'] ?>" readonly="readonly"></input>
                                                                                <br>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="text" name="Asignatura" value="<?php echo $row['Asignatura'] ?> " readonly="readonly"></input>
                                                                                <br/>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="text" name="lugarDeRevision" value="<?php echo $row['Lugar'] ?>" readonly="readonly"></input>
                                                                                <br/>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="date" name="fechaRevision" value="<?php echo $row['Fecha'] ?>" readonly="readonly"></input>
                                                                                <br/>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="time" name="horaRevision" value="<?php echo $row['Hora'] ?>" readonly="readonly"></input>
                                                                                <br/>
                                                                            </td>
                                                                        </tr>
                                                                        <td colspan="2" style="text-align:center;">
                                                                            <input name="enviar" value="Borrar" class="submit" type="submit"></input>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
